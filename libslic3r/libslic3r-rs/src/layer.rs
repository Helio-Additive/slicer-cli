...
impl LayerRegion {
    ...
    pub fn make_perimeters(
        ...
        let _spiral_mode = false; // TODO: Get from print_config
        ...
        let perimeter_config = PerimeterConfig {
            ...
            surface_simplify_resolution: 0.0125, // TODO: Get from print_config.resolution
            arc_fitting_enabled: false,          // TODO: Get from print_config
        ...
        if !result.gap_fills.is_empty() {
            ...
            let _ext_pw = config.outer_wall_line_width.max(0.4);
            let _max_gap_area = 100.0; // 100mm² — only filter truly huge polygons
    ...
    pub fn process_external_surfaces(
        &mut self,
        _lower_layer_covered: &ExPolygons,
        _config: &PrintRegionConfig,
    ) -> Result<()> {
        // Constants from C++
        // LayerRegion.cpp:312
...
impl Layer {
    ...
    /// Check if layer is empty (no extrusions)
    /// Layer.cpp:357-370
    ...
    pub fn make_perimeters_with_lower(
        ...
        // Store lower slices in each region's perimeter config
    ...
    /// Check if layer needs raw backup
    /// Layer.cpp:542-548
    ...
    pub fn make_fills(
        ...
        for surface_fill in surface_fills {
            ...
            let link_max_length = if !surface_fill.params.bridge {
                // Fill.cpp:687-693
                if surface_fill.params.density > 80.0 {
                    // C++: link_max_length = 3. * f->spacing;
                    (3.0 * surface_fill.params.spacing) as i64
                } else {
                    0
                }
            } else {
            ...
            let infill_config = InfillConfig {
                ...
                connect_infill: link_max_length == 0,
            };
