...
impl PrintObject {
    ...
    pub fn slice(&mut self) -> Result<()> {
        ...
        slicing_params.first_layer_height = self.config.first_layer_height;
    ...
    pub fn make_perimeters(&mut self) -> Result<()> {
        ...
        for (idx, layer) in self.layers.iter_mut().enumerate() {
            ...
            // PrintObject.cpp:560
            layer.make_perimeters_with_lower(&region_configs, lower_slices)?;
        }
    ...
    fn discover_horizontal_shells(&mut self) -> Result<()> {
        ...
        use crate::geometry::{to_polygons, ExPolygon, Polygons};
            ...
            for i in 0..self.layers.len() {
                ...
                for idx_surface_type in 0..3 {
                    ...
                    let num_solid_layers = if surface_type == SurfaceType::Top {
                        3 // TODO: Get from region_config.top_shell_layers
                    } else {
                        3 // TODO: Get from region_config.bottom_shell_layers
                    };
                    ...
                    // C++:     (type == stTop) ? --n : ++n)
                    let top_shell_thickness = 0.6; // TODO: Get from region_config
                    let bottom_shell_thickness = 0.6; // TODO: Get from region_config
                    let epsilon = 1e-4;
                    ...
                    while if surface_type == SurfaceType::Top {
                        ...
                        if new_internal_solid.is_empty() {
                            ...
                            // C++:     continue;
                            // C++: }
                            let sparse_infill_density = 20.0; // TODO: Get from region_config
                        ...
                        if sparse_infill_density == 0.0 {
                            ...
                            let _clipper_safety = 0.0001; // ClipperSafetyOffset = 10 scaled units = 0.0001mm
