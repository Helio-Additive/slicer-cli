...
impl Print {
    ...
    pub fn export_gcode(&self, output_path: &std::path::Path) -> Result<()> {
        ...
        stats.layer_count = ws.layer_count;
        stats.max_z_height = ws.max_z_height;
        ...
        // filament_density stays 0.0 (matching BambuStudio header behaviour)
...
impl Print {
    ...
    fn _make_skirt(&mut self) -> Result<()> {
        ...
        // Print.cpp:2359-2362
        let skirt_distance_scaled = scale(self.config.skirt_distance) as f64;
        let skirt_shape_expolygons = clipper_utils::offset_polygons(
            &[convex_hull],
            skirt_distance_scaled,
        ...
        for loop_idx in 0..self.config.skirt_loops {
            ...
            let loop_offset_f64 =
                skirt_distance_scaled as f64 + scale(nozzle_diameter) as f64 * (loop_idx as f64);
