...
use super::csg_mesh::{CSGPart, CSGType, MeshPtr};
...
pub fn model_to_csgmesh(
    ...
    for vol in volumes {
        ...
        // Compute combined transform: trafo * vol.matrix
        // ModelToCSGMesh.hpp:66
        // TODO: Compose transforms when matrix multiplication is implemented
        let combined_transform = *trafo;
