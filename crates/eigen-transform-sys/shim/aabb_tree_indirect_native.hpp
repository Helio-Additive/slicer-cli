...
// R190 shim copy: BoundingBox.hpp / Utils.hpp / igl includes replaced with the
// minimal local definitions below (verbatim from Utils.hpp:484-495 / igl/Hit.h).
#include <cstdint>
namespace igl { struct Hit { int id; int gid; float u, v; float t; }; }
namespace Slic3r {
